...
import (
	...
	"github.com/syhily/bookworm/utilities/casing"
)
...
// CLI is an optional command-line interface for a Bookworm service. It is provided
...
var optionsKey contextKey = "bookworm/cli/options"
...
//		Run: cli.WithOptions(func(cmd *cobra.Command, args []string, opts *Options) {
...
//
//	// Then, create the CLI.
//	cli := cli.CLI(func(hooks cli.Hooks, opts *Options) {
